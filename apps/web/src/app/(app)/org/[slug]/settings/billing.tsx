          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {billing.projects.price.toLocaleString('en-CA', {
                    style: 'currency',
                    currency: 'CAD',
                  })}{' '}
                  (
                  {billing.projects.unit.toLocaleString('en-CA', {
                    style: 'currency',
                    currency: 'CAD',
                  })}{' '}
                  each)
              ...
              <TableRow>
                ...
                <TableCell className="text-right">
                  {billing.seats.price.toLocaleString('en-CA', {
                    style: 'currency',
                    currency: 'CAD',
                  })}{' '}
                  (
                  {billing.seats.unit.toLocaleString('en-CA', {
                    style: 'currency',
                    currency: 'CAD',
                  })}{' '}
                  each)
            ...
            <TableFooter>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {billing.total.toLocaleString('en-CA', {
                    style: 'currency',
                    currency: 'CAD',
                  })}
                </TableCell>
